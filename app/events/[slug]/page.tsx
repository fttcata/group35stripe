              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                ...
                {event.distance && (
                  <div className="bg-emerald-50 rounded-xl p-4">
                    ...
                    <div className="text-gray-800">{event.distance}</div>
                  </div>
                )}
                <div className="bg-yellow-50 rounded-xl p-4">
                  <div className="text-yellow-700 font-semibold">Rating</div>
                  <div className="text-gray-800">{event.rating ? event.rating.toFixed(1) : '—'}</div>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-lg p-8 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <label className={`flex items-center gap-3 rounded-xl border p-4 cursor-pointer ${paymentOption === 'pay-now' ? 'border-purple-500 bg-purple-50' : 'border-gray-200'}`}>
                  <input
                    type="radio"
                    name="payment"
                    value="pay-now"
                ...
                <label className={`flex items-center gap-3 rounded-xl border p-4 cursor-pointer ${paymentOption === 'pay-on-day' ? 'border-purple-500 bg-purple-50' : 'border-gray-200'}`}>
                  <input
                    type="radio"
                    name="payment"
                    value="pay-on-day"
